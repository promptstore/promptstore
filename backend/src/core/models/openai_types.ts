...
export interface ResponseFormat {
  type: string;  // Must be one of "text", "json_object", or "json_schema". Defaults to text.
...
export interface OpenAIChatCompletionRequest {
  ...
  max_tokens?: number;  // DEPRECATED in favor of max_completion_tokens, and not compatible with o1-series/newer models. The maximum number of tokens to generate in the chat completion.
  ...
  reasoning_effort?: string;  // Constrains effort on reasoning for reasoning models. One of "minimal", "low", "medium", or "high".
...
interface OpenAIChatCompletionChoice {
  ...
  logprobs?: LogProbs | null;  // Log probability information for the choice.
}
...
export interface OpenAIChatCompletionResponse {
  ...
  system_fingerprint?: string;  // The backend configuration that the model runs with, for use with the seed request parameter.
